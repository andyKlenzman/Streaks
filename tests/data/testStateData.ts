...
export const initialState:RootState= {
    streaks: [
      { id: '1', title: 'do a pushup', count: 54, status: 'pending', lastTimeUpdated: currentTime },
      { id: '2', title: 'talk to someone new', count: 3, status: 'broken', lastTimeUpdated: pastStreakDeadline },
